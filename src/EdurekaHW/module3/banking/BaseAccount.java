...
public class BaseAccount{
    ...
    public void CreateNewAccount(String AccountType){
        ...
        int amount = scannerAccountnumber.nextInt();
...
//        System.out.println("getMaxAccountnumber value is "+getMaxAccountnumber);
    ...
    public void setAmount(int amount,int Accountnumber) {
...
class SB_Account extends BaseAccount{

}

class Current_Account extends BaseAccount{
