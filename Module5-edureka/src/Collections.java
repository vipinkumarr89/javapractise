...
public class Collections {
	 ...
	 */
	  ...
	  */ 
		...
		li.addFirst("java");
		li.addLast ("All are collections...");
		System.out.println(li);
		*/ 
...
/*	   
  ...
  */
    ...
    /*	HashMap<String, Double> hm = new HashMap<String, Double>();
		...
		hm.put("Surendra", new Double(3434.00));
		hm.put("Charan",  new Double (1235.22));
		hm.put("Divya", new Double(1378.00));
		hm.put("Wei_Shao", new Double(99.22));
		hm.put("Xingmeng", new Double(19.08));
		...
		double balance = hm.get("Charan");
		hm.put("Charan", balance + 4000);
